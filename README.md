...
In its present intermediate form, two instances of the same rotating object are rendered from each Wavefront .obj file. Each Wavefront .obj file describes one object.
